...
from domain_utils import random_sat, graph_coloring, color_verification, game24
__all__ = ["random_sat","graph_coloring","color_verification", "game24"]
domains = {"random_sat":random_sat,"graph_coloring":graph_coloring,"color_verification":color_verification, "game24":game24}
